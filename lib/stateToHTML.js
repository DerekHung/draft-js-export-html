...
var ENTITY_ATTR_MAP = (_ENTITY_ATTR_MAP = {}, _defineProperty(_ENTITY_ATTR_MAP, ENTITY_TYPE.DOCUMENT, { fileId: 'fileId' }), _defineProperty(_ENTITY_ATTR_MAP, ENTITY_TYPE.HYPERLINK, { fileId: 'fileId', url: 'url' }), _defineProperty(_ENTITY_ATTR_MAP, ENTITY_TYPE.YOUTUBE, { src: 'src', file: 'file', url: 'url' }), _defineProperty(_ENTITY_ATTR_MAP, ENTITY_TYPE.LINK, { url: 'href', rel: 'rel', target: 'target', title: 'title', className: 'class' }), _defineProperty(_ENTITY_ATTR_MAP, ENTITY_TYPE.IMAGE, { fileId: 'fileId' }), _defineProperty(_ENTITY_ATTR_MAP, ENTITY_TYPE.VIDEO, { fileId: 'fileId' }), _defineProperty(_ENTITY_ATTR_MAP, ENTITY_TYPE.AUDIO, { fileId: 'fileId' }), _ENTITY_ATTR_MAP);
