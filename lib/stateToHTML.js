...
var ENTITY_ATTR_MAP = (_ENTITY_ATTR_MAP = {}, _defineProperty(_ENTITY_ATTR_MAP, ENTITY_TYPE.DOCUMENT, { fileId: 'fileId', className: 'class' }), _defineProperty(_ENTITY_ATTR_MAP, ENTITY_TYPE.HYPERLINK, { src: 'src', className: 'class' }), _defineProperty(_ENTITY_ATTR_MAP, ENTITY_TYPE.YOUTUBE, { src: 'src', width: 'width', height: 'height', className: 'class' }), _defineProperty(_ENTITY_ATTR_MAP, ENTITY_TYPE.LINK, { url: 'href', rel: 'rel', target: 'target', title: 'title', className: 'class' }), _defineProperty(_ENTITY_ATTR_MAP, ENTITY_TYPE.IMAGE, { fileId: 'fileId', height: 'height', width: 'width', alt: 'alt', className: 'class' }), _defineProperty(_ENTITY_ATTR_MAP, ENTITY_TYPE.VIDEO, { fileId: 'fileId', height: 'height', width: 'width', alt: 'alt', className: 'class', controls: 'controls' }), _defineProperty(_ENTITY_ATTR_MAP, ENTITY_TYPE.AUDIO, { fileId: 'fileId', height: 'height', width: 'width', alt: 'alt', className: 'class', controls: 'controls' }), _ENTITY_ATTR_MAP);

// Map entity data to element attributes.

var DATA_TO_ATTR = (_DATA_TO_ATTR = {}, _defineProperty(_DATA_TO_ATTR, ENTITY_TYPE.DOCUMENT, function (entityType, entity) {
  ...
  return attrs;
}), _defineProperty(_DATA_TO_ATTR, ENTITY_TYPE.HYPERLINK, function (entityType, entity) {
  var attrMap = ENTITY_ATTR_MAP.hasOwnProperty(entityType) ? ENTITY_ATTR_MAP[entityType] : {};
  var data = entity.getData();
  var attrs = {};
  ...
  return attrs;
}), _defineProperty(_DATA_TO_ATTR, ENTITY_TYPE.AUDIO, function (entityType, entity) {
  var attrMap = ENTITY_ATTR_MAP.hasOwnProperty(entityType) ? ENTITY_ATTR_MAP[entityType] : {};
  var data = entity.getData();
  var attrs = {};
  ...
  return attrs;
}), _defineProperty(_DATA_TO_ATTR, ENTITY_TYPE.YOUTUBE, function (entityType, entity) {
  var attrMap = ENTITY_ATTR_MAP.hasOwnProperty(entityType) ? ENTITY_ATTR_MAP[entityType] : {};
  var data = entity.getData();
  var attrs = {};
  ...
  return attrs;
}), _defineProperty(_DATA_TO_ATTR, ENTITY_TYPE.VIDEO, function (entityType, entity) {
  var attrMap = ENTITY_ATTR_MAP.hasOwnProperty(entityType) ? ENTITY_ATTR_MAP[entityType] : {};
  var data = entity.getData();
  var attrs = {};
...
function stringifyAttrs(attrs) {
  ...
  try {
    for (var _iterator10 = Object.keys(attrs)[Symbol.iterator](), _step10; !(_iteratorNormalCompletion10 = (_step10 = _iterator10.next()).done); _iteratorNormalCompletion10 = true) {
      var attrKey = _step10.value;
